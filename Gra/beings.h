...
//        this->shape.setTextureRect(sf::IntRect(44,this->deathanim, 44,44));
//        explosionsound.play();
//       this-> deathanim+=100;
//        if(this->deathanim>=6500){
//            this->deathanim=44; this->dead=1;
//            ///break;
//        }
//        //this->death.push_back(Deathanim(alltextures.GetTexture(Textures::enemyexpTex), player.shape.getPosition()));
//        ///  for (size_t i = 0; i < player.death.size(); i++){
//        //   player.death[i].shape.setTextureRect(sf::IntRect(44,enemydeathanim, 44,44));
...
public:
    ...
    // virtual void collision(Vector2u windowSize)override;
